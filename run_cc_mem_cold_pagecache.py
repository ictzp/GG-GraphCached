...
def run_cc(filename, k):
	...
	moniter = subprocess.Popen(["/home/zhaopeng/graph/GG-GraphCached/tools/io_monitor.sh", pid, "wcc_2G_2_16G_directio_cacheap.result"])
	t = p.stdout.read()
	moniter.kill()
	print "monitor stops"
	f = open("wcc_coldpagecache_2G_2_16G_twitter_directio_cacheap.result", "a")
	f.write(t)
	print t
